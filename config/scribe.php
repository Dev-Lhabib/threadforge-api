...
return [
    ...
    'title' => 'ThreadForge API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API headless de repurposing de contenu tech en posts sociaux, propulsée par l\'IA.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Récupère ton token via /api/login, puis colle-le ici pour tester les endpoints protégés directement depuis la doc.',
    ],
